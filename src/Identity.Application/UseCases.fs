...
module UseCases = 
    ...
    let login(getUser: GetUser)(generateToken: GenerateToken)(publishIntegrationEvent: PublishIntegrationEvent)(mapError: MapDomainToApplicationError)(user: LoginUserDto) : Task<Result<UserToken, ApplicationError>> = 
        task {
